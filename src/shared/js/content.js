  ...
  getState.then((active) => {
    if (active) {
      ...
      const getEditBox = (elementId) => {
        return `<a class="csk-button csk-edit-button"
        href="https://app.contentful.com/spaces/${CONTENTFUL_CURRENT_SPACE_ID}/environments/${CONTENTFUL_ENVIRONMENT}/entries/${elementId}"
        target="_blank"></a>`;
      };
