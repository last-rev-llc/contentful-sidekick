...
const Sidekick = ({ defaultTree }) => {
  ...
  const { handleLogin, handleLogout, user, withUserCheck } = useContentfulContext();
  ...
  return (
    <ThemeProvider theme={theme}>
      <TreeProvider tree={tree}>
        ...
        <SpeedDial
          ...
          <EditableComponent>
            <SpeedDialAction
              ...
              tooltipPlacement="right"
              onClick={withUserCheck(() => setAddToTemplate())}
              color={highlight ? 'primary' : 'secondary'}
            />
          </EditableComponent>
          <EditableComponent>
            <SpeedDialAction
              ...
              tooltipTitle={!!user ? `Log Out <${user}>` : 'Log In'}
              tooltipPlacement="right"
        ...
        {highlight ? <ElementHighlighter setAddToTemplate={withUserCheck(() => setAddToTemplate())} /> : null}
        <AddContentDialog
          open={!!addToTemplate}
          {...addToTemplate}
          addToTemplate={addToTemplate}
          handleClose={withUserCheck(() => setAddToTemplate())}
        />
      </TreeProvider>
    </ThemeProvider>
  );
